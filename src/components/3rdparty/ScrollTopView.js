// locally forked from the original copy at https://github.com/yzsolo/react-native-scrolltotop

/**
 * @回到顶部
 * (translation, courtesy of google: "back to the top")
 */
...
export default class ScrollToTop extends Component {
    ...
    _onPress() {
         ...
         * (translation courtesy of google: "Both use the native drop-down refresh component")
         */

        if (this.props.onPress) {
            // if they supplied a callback, call it
            this.props.onPress();
        }
        else {
